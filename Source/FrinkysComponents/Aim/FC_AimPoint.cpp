...
void UFC_AimPoint::OnAimPointDeselected_Implementation()
{
	OnAimPointDeselectedDelegate.Broadcast();
}

void UFC_AimPoint::OnAimPointSelected_Implementation()
{
	OnAimPointSelectedDelegate.Broadcast();
}

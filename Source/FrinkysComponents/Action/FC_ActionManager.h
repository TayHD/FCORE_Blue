...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Action", meta=(ToolTip="Adds action to queue", AutoCreateRefTerm = "Payload", AdvancedDisplay = "Payload", Keywords="Add Action Start Execute"))
	...
	UFUNCTION(BlueprintPure, Category = "Action")
	bool DoesActionExist(TSubclassOf<AFC_Action> ActionToCheck);

	UFUNCTION(BlueprintCallable, Category = "Action")
	void EvaluateActions();
	
	UFUNCTION()
	void ExecuteAction(TSubclassOf<AFC_Action>& ActionToExecute, EActionExecutionContext ExecutionContext, UObject* Payload);

...
#include "FrinkysComponents/Surface/FC_SurfaceDataAsset.h"
...
public:
	...
	UPROPERTY(SaveGame, BlueprintReadOnly, EditAnywhere, Category="Gun|Basic", meta=(ToolTip="If this is set, the gun will use the surface data, and play the niagara/sound effect based upon surface impact"))
	UFC_SurfaceDataAsset* SurfaceData;
	...
	UPROPERTY(SaveGame, BlueprintReadOnly, Category="Gun|Misc", ReplicatedUsing=OnRep_FireMode)
	EFireMode FireMode;
	UPROPERTY()
	...
	UFUNCTION(BlueprintCallable, Category="Gun Component", Client, Reliable, meta=(ToolTip="Stops firing the weapon with selected firemode"))
	void FireStopClient();
	...
	void HandleSurfaceImpacts(const TArray<FCustomHitData>& HitResults);

	UFUNCTION(Server, Unreliable, BlueprintCallable)
	void ServerHandleSurfaceImpacts(const TArray<FCustomHitData>& HitResults);

	UFUNCTION(NetMulticast, Unreliable, BlueprintCallable)
	void MultiHandleSurfaceImpacts(const TArray<FCustomHitData>& HitResults);
	...
	UPROPERTY(BlueprintAssignable)
	FGunMulticast OnFireModeChange;
};
